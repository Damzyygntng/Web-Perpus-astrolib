...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/kelolapeminjaman.css') }}">
...
<li>
  ...
  <ul class="dropdown-menu" id="dropdownMenu">
    ...
    <li><a href="dashboard">Laporan user</a></li>
...
<div class="content">
  ...
  <form method="GET" action="/kelolapeminjaman" class="top-bar">
...
<script src="{{ asset('js/kelolapeminjaman.js') }}"></script>
</body>
</html>