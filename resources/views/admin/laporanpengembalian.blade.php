...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <link rel="stylesheet" href="css/laporanpengembalian.css">
    <title>Generate Laporan Buku</title>
</head>
<body>
    <div class="sidebar">
 <div class="logo">
...
<div class="popup" id="popup">
    ...
    <div class="popup-box">
        ...
        <div class="popup-footer">
            ...
            <a href="/cetakpengembalian" class="btn-print">
                Cetak
            </a>
...
<script src="js/laporanpengembalian.js"></script>
</body>
</html>