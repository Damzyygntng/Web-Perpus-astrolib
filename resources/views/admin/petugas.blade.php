...
<head>
    ...
    <link rel="stylesheet" href="css/kelolapetugas.css">
...
<li>
  ...
  <div class="content">
    ...
    <h2 class="judul-halaman">Kelola Petugas</h2>
    ...
    <div class="popup popup-hapus">
        ...
        <form id="formHapus"
            ...
            <div class="hapus-content">
                ...
                <p>
                    Petugas ini akan dihapus permanen.
                </p>
...
<script src="js/kelolapetugas.js"></script>
</body>
</html>